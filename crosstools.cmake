function(prepare_crosstool)
    ...
    if(NOT "${XOS_BUILD_TARGET}" STREQUAL "")
        ...
        file(ARCHIVE_EXTRACT INPUT "crosstools/${CROSSTOOL_NAME}.tgz"
             DESTINATION crosstools/)
        ...
        set(CMAKE_SYSTEM_PROGRAM_PATH
            "${CMAKE_SOURCE_DIR}/crosstools/${CROSSTOOL_NAME}/bin")
        set(CMAKE_FIND_ROOT_PATH
            "${CMAKE_SOURCE_DIR}/crosstools/${CROSSTOOL_NAME}/x86_64-linux-musl"
        )
        # SET(CMAKE_INSTALL_PREFIX
        # "${CMAKE_SOURCE_DIR}/crosstools/${CROSSTOOL_NAME}")
        ...
        link_directories(
            "${CMAKE_SOURCE_DIR}/crosstools/${CROSSTOOL_NAME}/${XOS_BUILD_TARGET}-linux-musl/lib"
        )
