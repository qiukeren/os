...
extern unsigned int scan_nbbint(const char*,
                                unsigned int,
                                unsigned int,
                                unsigned int,
                                unsigned int*);
...
extern unsigned int scan_nbbshort(const char*,
                                  unsigned int,
                                  unsigned int,
                                  unsigned int,
                                  unsigned short*);
...
extern unsigned int scan_nbblong(const char*,
                                 unsigned int,
                                 unsigned int,
                                 unsigned int,
                                 unsigned long*);
...
extern unsigned int scan_noncharsetnskip(const char*,
                                         const char*,
                                         unsigned int);
